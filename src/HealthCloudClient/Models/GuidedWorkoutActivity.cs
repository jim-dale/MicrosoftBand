...
namespace HealthCloudClient
{
    ...
    public class GuidedWorkoutActivity
    {
        ...
        /// RoundsPerformed counts the number of complete circuit rounds actually performed.
        /// Partial circuits are not counted
        /// </value>
        public int? RoundsPerformed { get; set; }
        /// <value>The number of exercise repetitions actually performed</value>
