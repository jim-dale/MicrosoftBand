...
namespace HealthCloudClient
{
    ...
    public class HikeActivity
    {
        ...
        /// <value>The elevation gained</value>
        public float? AscentRate { get; set; }
        /// <value>The maximum elevation gain</value>
        public float? MaxAscentRate { get; set; }
        /// <value>The elevation lost</value>
        public float? DescentRate { get; set; }
        /// <value>The maximum elevation lost rate</value>
        public float? MaxDescentRate { get; set; }
        /// <value>The time detected as resting (does not include paused time)</value>
        public TimeSpan? RestingDuration { get; set; }
        /// <value>The time detected as active (does not include paused time)</value>
        public TimeSpan? ActiveDuration { get; set; }
        /// <value>The segments associated with this activity</value>
        public HikeSegment[] ActivitySegments { get; set; }
